...
public class CuentaCorrienteACreditoGold extends CuentaCorrienteACredito {
    ...
    /**
     * Esta cuenta permite un descubierto de hasta 3000 €, si es más
     * lanza una exception
     * 
     * @param abono 
     */
    ...
    public void abona(double abono) {
        if (abono >= getSaldo() + 3000.0) {
            try {
                throw new Exception("Esta cuenta permite un descubierto de hasta 3000€: " + abono, new InvalidParameterException());
            } catch (Exception ex) {
